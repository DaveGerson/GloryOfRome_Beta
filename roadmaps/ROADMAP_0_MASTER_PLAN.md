...
5. **Inferred ambition (D8).** A cheap periodic model call infers what the player *appears* to be pursuing; feeds the epilogue and NPC perception of the player. Never a quest log.
