...
- Introduce 0-2 rumors per turn via 'rumor' deltas. A rumor's 'delta' field is its credibility (0.0 to 1.0). EVERY 'rumor' delta MUST also carry two GM-private bookkeeping fields:
...
- PLANTED RUMORS & COUNTERPLAY (lies in play):
    ...
    - NPC PLANTING: NPCs may plant rumors in service of their 'active_scheme' under the same contract: a 'rumor' delta with 'is_true' false for a fabricated lie (true for a weaponized truth) and 'origin_id' set to the planting NPC's entity_id.
