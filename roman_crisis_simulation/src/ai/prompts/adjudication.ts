...
- RESOURCE FEASIBILITY & COSTS: Characters cannot spend resources they do not possess. If an action requires money (such as paying bribes, donatives, buying loyalty, or hiring mercenaries/informants) and the acting entity has 0 or insufficient denarii, the action cannot succeed on financial terms alone. NPCs in Rome do not accept empty promises or worthless IOUs without collateral; they will demand proof of coin, reject empty promises, or treat the attempt with contempt or hostility unless backed by overwhelming martial coercion or personal leverage. A character who lacks denarii must leverage their actual assets (military command, intimidation, political alliances, prestige, or espionage) rather than coin.
