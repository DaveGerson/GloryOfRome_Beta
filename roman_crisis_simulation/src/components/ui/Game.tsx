...
export const DestinyCard: React.FC<{
    ...
    <button type="button" className="gor-destiny" onClick={onSelect} disabled={disabled} style={style}>
        ...
        {seal && <span aria-hidden="true" style={{ width: 46, height: 46, margin: '2px auto 2px', display: 'grid', placeItems: 'center', borderRadius: '46% 54% 52% 48% / 52% 46% 54% 48%', background: 'var(--seal-crimson)', boxShadow: 'inset 0 2px 3px rgba(255,255,255,.28), inset 0 -3px 5px rgba(0,0,0,.35), 0 2px 5px rgba(58,44,16,.35)', color: 'var(--seal-letter)', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 19, textShadow: '0 -1px 1px rgba(0,0,0,.4)' }}>{seal}</span>}
