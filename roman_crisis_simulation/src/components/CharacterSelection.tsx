...
const CharacterSelection: React.FC<{
    ...
    return (
        <div style={{ flex: 1, overflowY: 'auto', padding: '30px 32px 56px' }}>
            <div style={{ maxWidth: 1080, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
                <div style={{ textAlign: 'center' }}>
                    <Medallion size={84} />
                    <h2 style={{ fontFamily: 'var(--font-epic)', fontWeight: 700, fontSize: 40, color: 'var(--tyrian-600)', marginTop: 6 }}>Choose Your Destiny</h2>
