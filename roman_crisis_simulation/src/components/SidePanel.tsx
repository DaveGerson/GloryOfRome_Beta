...
const SidePanel: React.FC<{
    ...
    mobileOpen?: boolean;
    onMobileClose?: () => void;
}> = ({ gameState, playerEntity, entities, currentEvents, worldState, simulationState, reports, knowledge, turnNumber, onSpendDeepAnalysis, onInvestigationOutcome, onExchange, runDomainMutation, interactionLocked = false, ai, isMockMode, eventHistory, turnHistory, pulsingTabs, onOccurrenceFinding, mobileOpen = false, onMobileClose }) => {
