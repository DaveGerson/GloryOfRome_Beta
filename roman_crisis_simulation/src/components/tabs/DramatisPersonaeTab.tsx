...
import { getRawThoughts, getInvestigationResult } from '../../ai/tools/intelligence';
...
const EntityDetails: React.FC<{
    ...
    ai: GoogleGenAI;
    isMockMode: boolean;
}> = ({ entity, playerEntity, isMember, onSpendInvestigation, onNewInvestigationResult, onAddSecretAsResource, ai, isMockMode }) => {
    ...
    const handleRequest = async (type: 'secrets' | 'beliefs' | 'scheme' | 'raw_thoughts', target: Entity) => {
...
const FactionSection: React.FC<{ 
    ...
    ai: GoogleGenAI;
    isMockMode: boolean;
}> = ({ faction, members, playerEntity, onSpendInvestigation, onNewInvestigationResult, onAddSecretAsResource, ai, isMockMode }) => {
...
const DramatisPersonaeTab: React.FC<{
    ...
    ai: GoogleGenAI;
    isMockMode: boolean;
}> = ({ playerEntity, entities, onSpendInvestigation, onNewInvestigationResult, onAddSecretAsResource, ai, isMockMode }) => {
